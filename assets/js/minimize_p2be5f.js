  ...
  PluginCarousel.prototype = {
    ...
    build: function () {
      ...
      if (isCarouselModule && this.options.items > 2) {
        this.options = $.extend(true, {}, this.options, { responsive: { 768: { items: 3 }, 1199: { items: this.options.items } } });
      }
...
jQuery(function ($) {
  $(document).on("s123.page.ready", function (event) {
    ...
    if (layoutNUM != "2" && layoutNUM != "15" && layoutNUM != "3" && layoutNUM != "11" && layoutNUM != "4" && layoutNUM != "20") {
      ...
      $("#mainNav")
        .off("escm.size.changed")
        .on("escm.size.changed", function () {
          if (!IsWizard()) {
            ResetMoreButton();
          } else {
            ReduseMenuSizeWhenWeDontHavePlace();
      ...
      if ($(".home_page:not(.rich_page)").length > 0) {
        $("#mainNav")
          ...
          .on("affix.bs.affix", function () {
            $(".navbar-fixed-top").css({ position: "fixed", bottom: "auto", top: "0" });
          });
        $("#mainNav")
          .off("affix-top.bs.affix")
          .on("affix-top.bs.affix", function () {
            $(".navbar-fixed-top").css({ position: "absolute", bottom: "0", top: "auto" });
          });
      } else {
        $(".navbar-fixed-top").css({ position: "", bottom: "", top: "" });
      }
    ...
    if (layoutNUM == "20") {
      ...
      if ($(".home_page:not(.rich_page)").length > 0) {
        ...
        $("#mainNav")
          .off("affix-top.bs.affix")
          .on("affix-top.bs.affix", function () {
            $(".navbar-fixed-top").css({ position: "absolute", bottom: -Math.abs(window.layout20_topMenuHeight), top: "auto" });
          });
      } else {
        $(".navbar-fixed-top").css({ position: "", bottom: "", top: "" });
      }
...
jQuery(function ($) {
  $(document).on("s123.page.ready", function (event) {
    ...
    if (layoutNUM == "3" || layoutNUM == "11") {
      ...
      $("#top-section,.s123-modules-container,.s123-pages-container,footer")
        .off("click.bodyCloseMenu")
        .on("click.bodyCloseMenu", function (e) {
...
function aboutModuleInitialize_Layout10() {
  $(document).on("s123.page.ready", function (event) {
    var $sections = $(
      "section.s123-module-about.layout-10,section.s123-module-about.layout-15,section.s123-module-about.layout-17,section.s123-module-about.layout-19,section.s123-module-about.layout-21,section.s123-module-about.layout-23"
    );
    $sections.each(function (index) {
      var $s = $(this);
          ...
          submitHandler: function (form) {
            ...
            $.ajax({
              ...
              success: function (data) {
                var dataObj = jQuery.parseJSON('{"websiteID":"8437729","moduleID":"5b44b23334c19"}');
                $form.trigger("reset");
...
function TimelineModuleInitialize() {
  $(document).on("s123.page.ready", function (event) {
    ...
    $(window)
      .off("scroll.timelineAnimate")
      .on("scroll.timelineAnimate", function () {
  ...
  (function (a) {
    ...
    FlipClock.Face = FlipClock.Base.extend({
      ...
      createDivider: function (b, c, d) {
        ...
        var f = [
            '<span class="' + this.factory.classes.divider + " " + (c ? c : "").toLowerCase() + '">',
            '<span class="' + this.factory.classes.label + '">' + (b ? b : "") + "</span>",
            e,
            "</span>",
          ],
          g = a(f.join(""));
      ...
      reset: function () {
        (this.factory.time = new FlipClock.Time(this.factory, this.factory.original ? Math.round(this.factory.original) : 0, { minimumDigits: this.factory.minimumDigits })),
...
function PromoModuleInitialize() {
  ...
  function PromoScreenChangeHandler(settings) {
    ...
    _.init = function () {
      ...
      if (IsWizard()) {
        $(document)
          .off("wizard.preview.device.changed.promoScreenChangeHandler_" + _.sectionID)
          .on("wizard.preview.device.changed.promoScreenChangeHandler_" + _.sectionID, function (event) {
      ...
      $this.find(".easy-pie-chart").each(function () {
        $(this).appear(function () {
          ...
          if (parseFloat($(this).data("percent")) <= 0) {
            $(this).css({ width: chartSize, height: chartSize });
          } else {
            $(this).easyPieChart({ barColor: $(this).data("custom-bar-color"), trackColor: false, scaleColor: false, lineWidth: 5, animate: 2000, size: chartSize });
          }
        });
      });
    });
  ...
  if (IsWizard() && !IsIE11()) {
    ...
    function updateBarWithDefColor(id, type) {
      if (id == "modules_color_second_section_main") {
        $(".s123-module-percentage:not(.bg-primary).layout-1").each(function () {
          var $this = $(this);
          let sectionMainColor =
            type != "input" ? getComputedStyle(document.documentElement).getPropertyValue("--modules_color_second_section_main") : topWindow.$("#modules_color_second_section_main").val();
          updateBarColor($this, sectionMainColor);
        });
      } else if (id == "modules_color_section_main") {
        $(".s123-module-percentage.bg-primary.layout-1").each(function () {
          var $this = $(this);
          let sectionMainColor = type != "input" ? getComputedStyle(document.documentElement).getPropertyValue("--modules_color_section_main") : topWindow.$("#modules_color_section_main").val();
          updateBarColor($this, sectionMainColor);
        });
      } else {
        $(".inside_page .bg-primary.s123-module-percentage.layout-1").each(function () {
          var $this = $(this);
          let sectionMainColor =
            type != "input" ? getComputedStyle(document.documentElement).getPropertyValue("--inside_modules_color_section_box_main") : topWindow.$("#inside_modules_color_section_box_main").val();
          updateBarColor($this, sectionMainColor);
        });
      }
    }
    function updateBarColor($this, cssVarColor) {
          ...
          .each(function (index) {
            ...
            $form.validate({
              ...
              submitHandler: function (form) {
                ...
                var bootboxDialog = bootbox
                  .alert({ title: translations.sending, message: $jobsLoadingMessage, className: "jobsConfirm, bootbox-jobs-form", backdrop: true })
...
function buildForm(websiteID, moduleID, uniqueID, w, uploadFile, customForm, customApplicationForm) {
  ...
  if (!customForm) {
    ...
    html +=
      '<input type="text" name="jobs_email" placeholder="' +
    ...
    if (!uploadFile) {
      ...
      html +=
        '<input type="file" class="form-control" name="jobs_upload_file" data-rule-jobs-file-size="5242880" data-msg-jobs-file-size="' +
        translations.uploadFileLimitSize.replace("{{mb_in_number}}", "5") +
        '">';
      html += "</div>";
      html += "</div>";
      html += "</div>";
...
function AutoSetProductsImage() {
  $(document).on("s123.page.load", function (event) {
    $(".s123-module-products").each(function () {
      var $thisModule = $(this);
      $thisModule
        .find(".product-image.autoFitByHeight")
        .first()
        .each(function () {
          var $this = $(this);
      ...
      $thisModule
        .find(".product-image.autoFitByWidth")
        .first()
        .each(function () {
          var $this = $(this);
